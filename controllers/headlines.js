...
<meta content='18-Week/Homework/Solutions/controllers/headlines.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='og:title'>
...
<meta content='https://uclax.bootcampcontent.com/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/controllers/headlines.js' property='og:url'>
<meta content='summary' property='twitter:card'>
<meta content='18-Week/Homework/Solutions/controllers/headlines.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='twitter:title'>
...
<title>18-Week/Homework/Solutions/controllers/headlines.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository · GitLab</title>
...
<meta name="csrf-token" content="fr3Hr6FDFy5zAlf55GWFZBVmfIgAodSlvuY5SxbhnfAEnPiObHdIigvp6ncliMWzZsN70r76lkmnseC/CLi8fA==" />
<script>
//<![CDATA[
...
<input type="hidden" name="path" id="path" value="18-Week/Homework/Solutions/controllers/headlines.js" />
</form>
...
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/tree/master/18-Week/Homework/Solutions/controllers">controllers</a>
</li>
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/controllers/headlines.js"><strong>
headlines.js
</strong>
</a></li>
</ul>
...
<a class="btn btn-sm" target="_blank" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/raw/master/18-Week/Homework/Solutions/controllers/headlines.js">Raw</a>
<a class="btn btn-sm" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blame/master/18-Week/Homework/Solutions/controllers/headlines.js">Blame</a>
<a class="btn btn-sm" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/commits/master/18-Week/Homework/Solutions/controllers/headlines.js">History</a>
<a class="btn btn-sm" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/315aee89cd71e382f781a6d81f4e7b37f5615c47/18-Week/Homework/Solutions/controllers/headlines.js">Permalink</a>
</div>
<div class='btn-group' role='group'>
<a class="btn btn-file-option" rel="nofollow" data-method="post" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2FUCLA-Coding-Boot-Camp%2F04-2017-Class-Repository%2Fedit%2Fmaster%2F18-Week%2FHomework%2FSolutions%2Fcontrollers%2Fheadlines.js&amp;namespace_key=231">Edit</a>
<a class="btn btn-default" rel="nofollow" data-method="post" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+replace+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2FUCLA-Coding-Boot-Camp%2F04-2017-Class-Repository%2Fblob%2Fmaster%2F18-Week%2FHomework%2FSolutions%2Fcontrollers%2Fheadlines.js&amp;namespace_key=231">Replace</a>
<a class="btn btn-remove" rel="nofollow" data-method="post" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+delete+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2FUCLA-Coding-Boot-Camp%2F04-2017-Class-Repository%2Fblob%2Fmaster%2F18-Week%2FHomework%2FSolutions%2Fcontrollers%2Fheadlines.js&amp;namespace_key=231">Delete</a>
</div>
...
<div class='blob-content' data-blob-id='8fd42292720816681202f0ca85a5087c57947e41'>
<pre class="code highlight"><code><span id="LC1" class="line"><span class="c1">// Controller for our headlines</span></span>
<span id="LC2" class="line"><span class="c1">// ============================</span></span>
<span id="LC3" class="line"></span>
<span id="LC4" class="line"><span class="c1">// Bring in our scrape script and makeDate scripts</span></span>
<span id="LC5" class="line"><span class="kd">var</span> <span class="nx">scrape</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;../scripts/scrape&quot;</span><span class="p">);</span></span>
<span id="LC6" class="line"><span class="kd">var</span> <span class="nx">makeDate</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;../scripts/date&quot;</span><span class="p">);</span></span>
<span id="LC7" class="line"></span>
<span id="LC8" class="line"><span class="c1">// Bring in the Headline and Note mongoose models</span></span>
<span id="LC9" class="line"><span class="kd">var</span> <span class="nx">Headline</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;../models/Headline&quot;</span><span class="p">);</span></span>
<span id="LC10" class="line"></span>
<span id="LC11" class="line"><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span></span>
<span id="LC12" class="line">  <span class="na">fetch</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">cb</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC13" class="line"></span>
<span id="LC14" class="line">    <span class="c1">// Run scrape function</span></span>
<span id="LC15" class="line">    <span class="nx">scrape</span><span class="p">(</span><span class="kd">function</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC16" class="line">      <span class="c1">// Here data is an array of article objects with headlines and summaries</span></span>
<span id="LC17" class="line">      <span class="c1">// Setting this to articles for clarity</span></span>
<span id="LC18" class="line">      <span class="kd">var</span> <span class="nx">articles</span> <span class="o">=</span> <span class="nx">data</span><span class="p">;</span></span>
<span id="LC19" class="line">      <span class="c1">// Make sure each article object has a date and is not saved by default</span></span>
<span id="LC20" class="line">      <span class="k">for</span> <span class="p">(</span><span class="kd">var</span> <span class="nx">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="nx">i</span> <span class="o">&lt;</span> <span class="nx">articles</span><span class="p">.</span><span class="nx">length</span><span class="p">;</span> <span class="nx">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC21" class="line">        <span class="nx">articles</span><span class="p">[</span><span class="nx">i</span><span class="p">].</span><span class="nx">date</span> <span class="o">=</span> <span class="nx">makeDate</span><span class="p">();</span></span>
<span id="LC22" class="line">        <span class="nx">articles</span><span class="p">[</span><span class="nx">i</span><span class="p">].</span><span class="nx">saved</span> <span class="o">=</span> <span class="kc">false</span><span class="p">;</span></span>
<span id="LC23" class="line">      <span class="p">}</span></span>
<span id="LC24" class="line">      <span class="c1">// Headline.collection lets us access the native Mongo insertMany method.</span></span>
<span id="LC25" class="line">      <span class="c1">// We&#39;re using this instead of the mongoose create method because here we may</span></span>
<span id="LC26" class="line">      <span class="c1">// specify whether this is an ordered or unordered insert</span></span>
<span id="LC27" class="line">      <span class="c1">// https://docs.mongodb.com/manual/reference/method/db.collection.insertMany/</span></span>
<span id="LC28" class="line">      <span class="c1">// unordered inserts have the benefit of being faster, and errors are logged instead</span></span>
<span id="LC29" class="line">      <span class="c1">// of thrown. This means that even if some of our inserts fail, the rest will continue</span></span>
<span id="LC30" class="line">      <span class="c1">// We expect an insert to fail whenever we have a duplicate headline since that property</span></span>
<span id="LC31" class="line">      <span class="c1">// is marked unique on the mongoose model</span></span>
<span id="LC32" class="line">      <span class="nx">Headline</span><span class="p">.</span><span class="nx">collection</span><span class="p">.</span><span class="nx">insertMany</span><span class="p">(</span><span class="nx">articles</span><span class="p">,</span> <span class="p">{</span> <span class="na">ordered</span><span class="p">:</span> <span class="kc">false</span> <span class="p">},</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">docs</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC33" class="line">        <span class="nx">cb</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">docs</span><span class="p">);</span></span>
...
<span id="LC37" class="line">  <span class="na">delete</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="nx">cb</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC38" class="line">    <span class="nx">Headline</span><span class="p">.</span><span class="nx">remove</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="nx">cb</span><span class="p">);</span></span>
<span id="LC39" class="line">  <span class="p">},</span></span>
<span id="LC40" class="line">  <span class="na">get</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="nx">cb</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC41" class="line">    <span class="c1">// Prepare a query to get the data we scraped,</span></span>
<span id="LC42" class="line">    <span class="c1">// and sort starting from most recent (sorted by id num)</span></span>
<span id="LC43" class="line">    <span class="nx">Headline</span><span class="p">.</span><span class="nx">find</span><span class="p">(</span><span class="nx">query</span><span class="p">)</span></span>
<span id="LC44" class="line">      <span class="p">.</span><span class="nx">sort</span><span class="p">({</span></span>
<span id="LC45" class="line">        <span class="na">_id</span><span class="p">:</span> <span class="o">-</span><span class="mi">1</span></span>
<span id="LC46" class="line">      <span class="p">})</span></span>
<span id="LC47" class="line">      <span class="c1">// Execute this query</span></span>
<span id="LC48" class="line">      <span class="p">.</span><span class="nx">exec</span><span class="p">(</span><span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">doc</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC49" class="line">        <span class="c1">// Once finished, pass the list into the callback function</span></span>
<span id="LC50" class="line">        <span class="nx">cb</span><span class="p">(</span><span class="nx">doc</span><span class="p">);</span></span>
<span id="LC51" class="line">      <span class="p">});</span></span>
<span id="LC52" class="line">  <span class="p">},</span></span>
<span id="LC53" class="line">  <span class="na">update</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="nx">cb</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC54" class="line">    <span class="c1">// Update the headline with the id supplied</span></span>
<span id="LC55" class="line">    <span class="c1">// set it to be equal to any new values we pass in on query</span></span>
<span id="LC56" class="line">    <span class="nx">Headline</span><span class="p">.</span><span class="nx">update</span><span class="p">({</span> <span class="na">_id</span><span class="p">:</span> <span class="nx">query</span><span class="p">.</span><span class="nx">_id</span> <span class="p">},</span> <span class="p">{</span></span>
<span id="LC57" class="line">      <span class="na">$set</span><span class="p">:</span> <span class="nx">query</span></span>
<span id="LC58" class="line">    <span class="p">},</span> <span class="p">{},</span> <span class="nx">cb</span><span class="p">);</span></span>
<span id="LC59" class="line">  <span class="p">}</span></span>
<span id="LC60" class="line"><span class="p">};</span></span></code></pre>
