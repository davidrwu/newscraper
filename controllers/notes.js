...
<meta content='18-Week/Homework/Solutions/controllers/notes.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='og:title'>
...
<meta content='https://uclax.bootcampcontent.com/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/controllers/notes.js' property='og:url'>
<meta content='summary' property='twitter:card'>
<meta content='18-Week/Homework/Solutions/controllers/notes.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='twitter:title'>
...
<title>18-Week/Homework/Solutions/controllers/notes.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository · GitLab</title>
...
<meta name="csrf-token" content="QpI0X5s7nvQM/QPQbBzFaD8KkG6J4TBWjkfy1aStHUg4swt+Vg/BUHQWvl6t8YW/TK+XNDe6crqXECshuvQ8xA==" />
<script>
//<![CDATA[
...
<input type="hidden" name="path" id="path" value="18-Week/Homework/Solutions/controllers/notes.js" />
</form>
...
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/controllers/notes.js"><strong>
notes.js
</strong>
</a></li>
</ul>
...
<a class="btn btn-sm" target="_blank" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/raw/master/18-Week/Homework/Solutions/controllers/notes.js">Raw</a>
<a class="btn btn-sm" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blame/master/18-Week/Homework/Solutions/controllers/notes.js">Blame</a>
<a class="btn btn-sm" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/commits/master/18-Week/Homework/Solutions/controllers/notes.js">History</a>
<a class="btn btn-sm" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/315aee89cd71e382f781a6d81f4e7b37f5615c47/18-Week/Homework/Solutions/controllers/notes.js">Permalink</a>
</div>
<div class='btn-group' role='group'>
<a class="btn btn-file-option" rel="nofollow" data-method="post" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2FUCLA-Coding-Boot-Camp%2F04-2017-Class-Repository%2Fedit%2Fmaster%2F18-Week%2FHomework%2FSolutions%2Fcontrollers%2Fnotes.js&amp;namespace_key=231">Edit</a>
<a class="btn btn-default" rel="nofollow" data-method="post" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+replace+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2FUCLA-Coding-Boot-Camp%2F04-2017-Class-Repository%2Fblob%2Fmaster%2F18-Week%2FHomework%2FSolutions%2Fcontrollers%2Fnotes.js&amp;namespace_key=231">Replace</a>
<a class="btn btn-remove" rel="nofollow" data-method="post" href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+delete+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2FUCLA-Coding-Boot-Camp%2F04-2017-Class-Repository%2Fblob%2Fmaster%2F18-Week%2FHomework%2FSolutions%2Fcontrollers%2Fnotes.js&amp;namespace_key=231">Delete</a>
</div>
...
<div class='blob-content' data-blob-id='413cea2bc9d61b8a43acd786afb6a6a0f3bd5546'>
<pre class="code highlight"><code><span id="LC1" class="line"><span class="c1">// Controller for our notes</span></span>
<span id="LC2" class="line"><span class="c1">// ========================</span></span>
<span id="LC3" class="line"></span>
<span id="LC4" class="line"><span class="kd">var</span> <span class="nx">Note</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;../models/Note&quot;</span><span class="p">);</span></span>
<span id="LC5" class="line"><span class="kd">var</span> <span class="nx">makeDate</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;../scripts/date&quot;</span><span class="p">);</span></span>
<span id="LC6" class="line"></span>
<span id="LC7" class="line"><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span></span>
<span id="LC8" class="line">  <span class="na">get</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">data</span><span class="p">,</span> <span class="nx">cb</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC9" class="line">    <span class="c1">// Find all notes with the headline id from the article we passed</span></span>
<span id="LC10" class="line">    <span class="nx">Note</span><span class="p">.</span><span class="nx">find</span><span class="p">({</span></span>
<span id="LC11" class="line">      <span class="na">_headlineId</span><span class="p">:</span> <span class="nx">data</span><span class="p">.</span><span class="nx">_id</span></span>
<span id="LC12" class="line">    <span class="p">},</span> <span class="nx">cb</span><span class="p">);</span></span>
<span id="LC13" class="line">  <span class="p">},</span></span>
<span id="LC14" class="line">  <span class="c1">// Save a note</span></span>
<span id="LC15" class="line">  <span class="c1">// Export this function as &quot;save&quot; (data = note info, cb = callback)</span></span>
<span id="LC16" class="line">  <span class="na">save</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">data</span><span class="p">,</span> <span class="nx">cb</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC17" class="line"></span>
<span id="LC18" class="line">    <span class="c1">// Make a newNote with the note model, saving the apropos info</span></span>
<span id="LC19" class="line">    <span class="kd">var</span> <span class="nx">newNote</span> <span class="o">=</span> <span class="p">{</span></span>
<span id="LC20" class="line">      <span class="na">_headlineId</span><span class="p">:</span> <span class="nx">data</span><span class="p">.</span><span class="nx">_id</span><span class="p">,</span></span>
<span id="LC21" class="line">      <span class="na">date</span><span class="p">:</span> <span class="nx">makeDate</span><span class="p">(),</span></span>
<span id="LC22" class="line">      <span class="na">noteText</span><span class="p">:</span> <span class="nx">data</span><span class="p">.</span><span class="nx">noteText</span></span>
<span id="LC23" class="line">    <span class="p">};</span></span>
<span id="LC24" class="line"></span>
<span id="LC25" class="line">    <span class="c1">// Save the newNote we made to mongoDB with mongoose&#39;s save function</span></span>
<span id="LC26" class="line">    <span class="nx">Note</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="nx">newNote</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">doc</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC27" class="line">      <span class="c1">// Log any errors</span></span>
<span id="LC28" class="line">      <span class="k">if</span> <span class="p">(</span><span class="nx">err</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC29" class="line">        <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">err</span><span class="p">);</span></span>
<span id="LC30" class="line">      <span class="p">}</span></span>
<span id="LC31" class="line">      <span class="c1">// Or just log the doc we saved</span></span>
<span id="LC32" class="line">      <span class="k">else</span> <span class="p">{</span></span>
<span id="LC33" class="line">        <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">doc</span><span class="p">);</span></span>
<span id="LC34" class="line">        <span class="c1">// Place the log back in this callback function</span></span>
<span id="LC35" class="line">        <span class="c1">// so it can be used with other functions asynchronously</span></span>
<span id="LC36" class="line">        <span class="nx">cb</span><span class="p">(</span><span class="nx">doc</span><span class="p">);</span></span>
...
<span id="LC40" class="line">  <span class="na">delete</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">data</span><span class="p">,</span> <span class="nx">cb</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC41" class="line">    <span class="c1">// Remove a Note using mongoose and our note Model,</span></span>
<span id="LC42" class="line">    <span class="c1">// searching by the article&#39;s id</span></span>
<span id="LC43" class="line">    <span class="nx">Note</span><span class="p">.</span><span class="nx">remove</span><span class="p">({</span></span>
<span id="LC44" class="line">      <span class="na">_id</span><span class="p">:</span> <span class="nx">data</span><span class="p">.</span><span class="nx">_id</span></span>
<span id="LC45" class="line">    <span class="p">},</span> <span class="nx">cb</span><span class="p">);</span></span>
<span id="LC46" class="line">  <span class="p">}</span></span>
<span id="LC47" class="line"><span class="p">};</span></span></code></pre>
