...
<meta content='18-Week/Homework/Solutions/models/Headline.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='og:title'>
...
<meta content='https://uclax.bootcampcontent.com/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/models/Headline.js' property='og:url'>
<meta content='summary' property='twitter:card'>
<meta content='18-Week/Homework/Solutions/models/Headline.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='twitter:title'>
...
<title>18-Week/Homework/Solutions/models/Headline.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository · GitLab</title>
...
<meta name="csrf-token" content="5se/Lm6SaqFcpD2hiYz+/Wk8nVlvC9t/tVEYJOPOeGic5oAPo6Y1BSRPgC9IYb4qGpmaA9FQmZOsBsHQ/ZdZ5A==" />
<script>
//<![CDATA[
...
<input type="hidden" name="path" id="path" value="18-Week/Homework/Solutions/models/Headline.js" />
</form>
...
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/models/Headline.js"><strong>
Headline.js
</strong>
</a></li>
</ul>
...
<div class='blob-content' data-blob-id='ecf27e83395a9a976c59809a8d25e291d76602e7'>
<pre class="code highlight"><code><span id="LC1" class="line"><span class="c1">// Headline model</span></span>
...
<span id="LC7" class="line"><span class="c1">// Create a schema class using mongoose&#39;s schema method</span></span>
<span id="LC8" class="line"><span class="kd">var</span> <span class="nx">Schema</span> <span class="o">=</span> <span class="nx">mongoose</span><span class="p">.</span><span class="nx">Schema</span><span class="p">;</span></span>
<span id="LC9" class="line"></span>
<span id="LC10" class="line"><span class="c1">// Create the headlineSchema with our schema class</span></span>
<span id="LC11" class="line"><span class="kd">var</span> <span class="nx">headlineSchema</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Schema</span><span class="p">({</span></span>
<span id="LC12" class="line">  <span class="c1">// headline, a string, must be entered</span></span>
<span id="LC13" class="line">  <span class="na">headline</span><span class="p">:</span> <span class="p">{</span></span>
<span id="LC14" class="line">    <span class="na">type</span><span class="p">:</span> <span class="nb">String</span><span class="p">,</span></span>
<span id="LC15" class="line">    <span class="na">required</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span></span>
<span id="LC16" class="line">    <span class="na">unique</span><span class="p">:</span> <span class="kc">true</span></span>
<span id="LC17" class="line">  <span class="p">},</span></span>
<span id="LC18" class="line">  <span class="c1">// summary, a string, must be entered</span></span>
<span id="LC19" class="line">  <span class="na">summary</span><span class="p">:</span> <span class="p">{</span></span>
<span id="LC20" class="line">    <span class="na">type</span><span class="p">:</span> <span class="nb">String</span><span class="p">,</span></span>
<span id="LC21" class="line">    <span class="na">required</span><span class="p">:</span> <span class="kc">true</span></span>
<span id="LC22" class="line">  <span class="p">},</span></span>
<span id="LC23" class="line">  <span class="c1">// url, a string, must be entered</span></span>
<span id="LC24" class="line">  <span class="na">url</span><span class="p">:</span> <span class="p">{</span></span>
<span id="LC25" class="line">    <span class="na">type</span><span class="p">:</span> <span class="nb">String</span><span class="p">,</span></span>
<span id="LC26" class="line">    <span class="na">required</span><span class="p">:</span> <span class="kc">true</span></span>
<span id="LC27" class="line">  <span class="p">},</span></span>
<span id="LC28" class="line">  <span class="c1">// date is just a string</span></span>
<span id="LC29" class="line">  <span class="na">date</span><span class="p">:</span> <span class="nb">String</span><span class="p">,</span></span>
<span id="LC30" class="line">  <span class="na">saved</span><span class="p">:</span> <span class="p">{</span></span>
<span id="LC31" class="line">    <span class="na">type</span><span class="p">:</span> <span class="nb">Boolean</span><span class="p">,</span></span>
<span id="LC32" class="line">    <span class="na">default</span><span class="p">:</span> <span class="kc">false</span></span>
<span id="LC33" class="line">  <span class="p">}</span></span>
<span id="LC34" class="line"><span class="p">});</span></span>
<span id="LC35" class="line"></span>
<span id="LC36" class="line"><span class="c1">// Create the Headline model using the headlineSchema</span></span>
<span id="LC37" class="line"><span class="kd">var</span> <span class="nx">Headline</span> <span class="o">=</span> <span class="nx">mongoose</span><span class="p">.</span><span class="nx">model</span><span class="p">(</span><span class="s2">&quot;Headline&quot;</span><span class="p">,</span> <span class="nx">headlineSchema</span><span class="p">);</span></span>
<span id="LC38" class="line"></span>
<span id="LC39" class="line"><span class="c1">// Export the Headline model</span></span>
<span id="LC40" class="line"><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="nx">Headline</span><span class="p">;</span></span></code></pre>
