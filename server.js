...
<meta content='18-Week/Homework/Solutions/server.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='og:title'>
...
<meta content='https://uclax.bootcampcontent.com/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/server.js' property='og:url'>
<meta content='summary' property='twitter:card'>
<meta content='18-Week/Homework/Solutions/server.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='twitter:title'>
...
<title>18-Week/Homework/Solutions/server.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository · GitLab</title>
...
<meta name="csrf-token" content="y7bXyv3XL7R/OV2JD6sg5ikKuqd6CCEhnfIfEU/7hxixl+jrMONwEAfS4AfORmAxWq+9/cRTY82EpcblUaKmlA==" />
<script>
//<![CDATA[
...
<input type="hidden" name="path" id="path" value="18-Week/Homework/Solutions/server.js" />
</form>
...
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/server.js"><strong>
server.js
</strong>
</a></li>
</ul>
...
<div class='blob-content' data-blob-id='e1a72a43c3d2d18dcf7e6fc03098094f507223d4'>
<pre class="code highlight"><code><span id="LC1" class="line"><span class="c1">// Web Scraper Homework Solution Example</span></span>
<span id="LC2" class="line"><span class="c1">// (be sure to watch the video to see</span></span>
<span id="LC3" class="line"><span class="c1">// how to operate the site in the browser)</span></span>
<span id="LC4" class="line"><span class="c1">// -/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/</span></span>
<span id="LC5" class="line"></span>
<span id="LC6" class="line"><span class="c1">// Require our dependencies</span></span>
<span id="LC7" class="line"><span class="kd">var</span> <span class="nx">express</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;express&quot;</span><span class="p">);</span></span>
<span id="LC8" class="line"><span class="kd">var</span> <span class="nx">mongoose</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;mongoose&quot;</span><span class="p">);</span></span>
<span id="LC9" class="line"><span class="kd">var</span> <span class="nx">expressHandlebars</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;express-handlebars&quot;</span><span class="p">);</span></span>
<span id="LC10" class="line"><span class="kd">var</span> <span class="nx">bodyParser</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;body-parser&quot;</span><span class="p">);</span></span>
<span id="LC11" class="line"></span>
<span id="LC12" class="line"><span class="c1">// Set up our port to be either the host&#39;s designated port, or 3000</span></span>
<span id="LC13" class="line"><span class="kd">var</span> <span class="nx">PORT</span> <span class="o">=</span> <span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">.</span><span class="nx">PORT</span> <span class="o">||</span> <span class="mi">3000</span><span class="p">;</span></span>
<span id="LC14" class="line"></span>
<span id="LC15" class="line"><span class="c1">// Instantiate our Express App</span></span>
<span id="LC16" class="line"><span class="kd">var</span> <span class="nx">app</span> <span class="o">=</span> <span class="nx">express</span><span class="p">();</span></span>
<span id="LC17" class="line"></span>
<span id="LC18" class="line"><span class="c1">// Set up an Express Router</span></span>
<span id="LC19" class="line"><span class="kd">var</span> <span class="nx">router</span> <span class="o">=</span> <span class="nx">express</span><span class="p">.</span><span class="nx">Router</span><span class="p">();</span></span>
<span id="LC20" class="line"></span>
<span id="LC21" class="line"><span class="c1">// Require our routes file pass our router object</span></span>
<span id="LC22" class="line"><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;./config/routes&quot;</span><span class="p">)(</span><span class="nx">router</span><span class="p">);</span></span>
<span id="LC23" class="line"></span>
<span id="LC24" class="line"><span class="c1">// Designate our public folder as a static directory</span></span>
<span id="LC25" class="line"><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">express</span><span class="p">.</span><span class="kr">static</span><span class="p">(</span><span class="nx">__dirname</span> <span class="o">+</span> <span class="s2">&quot;/public&quot;</span><span class="p">));</span></span>
<span id="LC26" class="line"></span>
<span id="LC27" class="line"><span class="c1">// Connect Handlebars to our Express app</span></span>
<span id="LC28" class="line"><span class="nx">app</span><span class="p">.</span><span class="nx">engine</span><span class="p">(</span><span class="s2">&quot;handlebars&quot;</span><span class="p">,</span> <span class="nx">expressHandlebars</span><span class="p">({</span></span>
<span id="LC29" class="line">  <span class="na">defaultLayout</span><span class="p">:</span> <span class="s2">&quot;main&quot;</span></span>
<span id="LC30" class="line"><span class="p">}));</span></span>
<span id="LC31" class="line"><span class="nx">app</span><span class="p">.</span><span class="nx">set</span><span class="p">(</span><span class="s2">&quot;view engine&quot;</span><span class="p">,</span> <span class="s2">&quot;handlebars&quot;</span><span class="p">);</span></span>
<span id="LC32" class="line"></span>
<span id="LC33" class="line"><span class="c1">// Use bodyParser in our app</span></span>
<span id="LC34" class="line"><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">bodyParser</span><span class="p">.</span><span class="nx">urlencoded</span><span class="p">({</span></span>
<span id="LC35" class="line">  <span class="na">extended</span><span class="p">:</span> <span class="kc">false</span></span>
<span id="LC36" class="line"><span class="p">}));</span></span>
<span id="LC37" class="line"></span>
<span id="LC38" class="line"><span class="c1">// Have every request go through our router middleware</span></span>
<span id="LC39" class="line"><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">router</span><span class="p">);</span></span>
<span id="LC40" class="line"></span>
<span id="LC41" class="line"></span>
<span id="LC42" class="line"><span class="c1">// If deployed, use the deployed database. Otherwise use the local mongoHeadlines database</span></span>
<span id="LC43" class="line"><span class="kd">var</span> <span class="nx">db</span> <span class="o">=</span> <span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">.</span><span class="nx">MONGODB_URI</span> <span class="o">||</span> <span class="s2">&quot;mongodb://localhost/mongoHeadlines&quot;</span><span class="p">;</span></span>
<span id="LC44" class="line"></span>
<span id="LC45" class="line"><span class="c1">// Connect mongoose to our database</span></span>
<span id="LC46" class="line"><span class="nx">mongoose</span><span class="p">.</span><span class="nx">connect</span><span class="p">(</span><span class="nx">db</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">error</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC47" class="line">  <span class="c1">// Log any errors connecting with mongoose</span></span>
<span id="LC48" class="line">  <span class="k">if</span> <span class="p">(</span><span class="nx">error</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC49" class="line">    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">error</span><span class="p">);</span></span>
<span id="LC50" class="line">  <span class="p">}</span></span>
<span id="LC51" class="line">  <span class="c1">// Or log a success message</span></span>
<span id="LC52" class="line">  <span class="k">else</span> <span class="p">{</span></span>
<span id="LC53" class="line">    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;mongoose connection is successful&quot;</span><span class="p">);</span></span>
<span id="LC54" class="line">  <span class="p">}</span></span>
<span id="LC55" class="line"><span class="p">});</span></span>
<span id="LC56" class="line"></span>
<span id="LC57" class="line"><span class="c1">// Listen on the port</span></span>
<span id="LC58" class="line"><span class="nx">app</span><span class="p">.</span><span class="nx">listen</span><span class="p">(</span><span class="nx">PORT</span><span class="p">,</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span></span>
<span id="LC59" class="line">  <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;Listening on port:&quot;</span> <span class="o">+</span> <span class="nx">PORT</span><span class="p">);</span></span>
