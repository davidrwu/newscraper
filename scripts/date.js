...
<meta content='18-Week/Homework/Solutions/scripts/date.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='og:title'>
...
<meta content='https://uclax.bootcampcontent.com/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/scripts/date.js' property='og:url'>
<meta content='summary' property='twitter:card'>
<meta content='18-Week/Homework/Solutions/scripts/date.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='twitter:title'>
...
<title>18-Week/Homework/Solutions/scripts/date.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository · GitLab</title>
...
<meta name="csrf-token" content="kEdQqWFYNr4piC+lit/zsRPK2e7tNCUpGF1me+M7IqvqZm+IrGxpGlFjkitLMrNmYG/etFNvZ8UBCr+P/WIDJw==" />
<script>
//<![CDATA[
...
<input type="hidden" name="path" id="path" value="18-Week/Homework/Solutions/scripts/date.js" />
</form>
...
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/scripts/date.js"><strong>
date.js
</strong>
</a></li>
</ul>
...
<div class='blob-content' data-blob-id='f099e8c66d989dfb74f2a39caa8566ad12321567'>
<pre class="code highlight"><code><span id="LC1" class="line"><span class="c1">// makeDate script</span></span>
<span id="LC2" class="line"><span class="c1">// ===============</span></span>
<span id="LC3" class="line"></span>
<span id="LC4" class="line"><span class="c1">// This function will make a formatted date for our scraped data</span></span>
<span id="LC5" class="line"><span class="kd">var</span> <span class="nx">makeDate</span> <span class="o">=</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span></span>
<span id="LC6" class="line">  <span class="c1">// Save the current date to d</span></span>
<span id="LC7" class="line">  <span class="kd">var</span> <span class="nx">d</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Date</span><span class="p">();</span></span>
<span id="LC8" class="line">  <span class="c1">// Prepare an empty string for our formatted state</span></span>
<span id="LC9" class="line">  <span class="kd">var</span> <span class="nx">formattedDate</span> <span class="o">=</span> <span class="s2">&quot;&quot;</span><span class="p">;</span></span>
<span id="LC10" class="line">  <span class="c1">// Take that string and concatenate the current month of d</span></span>
<span id="LC11" class="line">  <span class="nx">formattedDate</span> <span class="o">+=</span> <span class="p">(</span><span class="nx">d</span><span class="p">.</span><span class="nx">getMonth</span><span class="p">()</span> <span class="o">+</span> <span class="mi">1</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot;_&quot;</span><span class="p">;</span></span>
<span id="LC12" class="line">  <span class="c1">// Next get the number of the day in the month from d and concatenate it to the formatted date string.</span></span>
<span id="LC13" class="line">  <span class="nx">formattedDate</span> <span class="o">+=</span> <span class="nx">d</span><span class="p">.</span><span class="nx">getDate</span><span class="p">()</span> <span class="o">+</span> <span class="s2">&quot;_&quot;</span><span class="p">;</span></span>
<span id="LC14" class="line">  <span class="c1">// Finally, then get the full year, and add that to the formatted date string</span></span>
<span id="LC15" class="line">  <span class="nx">formattedDate</span> <span class="o">+=</span> <span class="nx">d</span><span class="p">.</span><span class="nx">getFullYear</span><span class="p">();</span></span>
<span id="LC16" class="line">  <span class="c1">// Return the formatted date</span></span>
<span id="LC17" class="line">  <span class="k">return</span> <span class="nx">formattedDate</span><span class="p">;</span></span>
<span id="LC18" class="line"><span class="p">};</span></span>
<span id="LC19" class="line"></span>
<span id="LC20" class="line"><span class="c1">// Export the makeDate function so other files in the backend can use it.</span></span>
<span id="LC21" class="line"><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="nx">makeDate</span><span class="p">;</span></span></code></pre>
