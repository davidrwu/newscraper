...
<meta content='18-Week/Homework/Solutions/scripts/scrape.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='og:title'>
...
<meta content='https://uclax.bootcampcontent.com/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/scripts/scrape.js' property='og:url'>
<meta content='summary' property='twitter:card'>
<meta content='18-Week/Homework/Solutions/scripts/scrape.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='twitter:title'>
...
<title>18-Week/Homework/Solutions/scripts/scrape.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository · GitLab</title>
...
<meta name="csrf-token" content="aAJufwjZX/npBZTgFITC3UPVnrV1gP+3Y3fxiTihVTcSI1Fexe0AXZHuKW7VaYIKMHCZ78vbvVt6ICh9Jvh0uw==" />
<script>
//<![CDATA[
...
<input type="hidden" name="path" id="path" value="18-Week/Homework/Solutions/scripts/scrape.js" />
</form>
...
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/tree/master/18-Week/Homework/Solutions/scripts">scripts</a>
</li>
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/scripts/scrape.js"><strong>
scrape.js
</strong>
</a></li>
</ul>
...
<div class='blob-content' data-blob-id='40ebce2a28b27d77465600df4f152f88479354a5'>
<pre class="code highlight"><code><span id="LC1" class="line"><span class="c1">// scrape script</span></span>
<span id="LC2" class="line"><span class="c1">// =============</span></span>
<span id="LC3" class="line"></span>
<span id="LC4" class="line"><span class="c1">// Require request and cheerio, making our scrapes possible</span></span>
<span id="LC5" class="line"><span class="kd">var</span> <span class="nx">request</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;request&quot;</span><span class="p">);</span></span>
<span id="LC6" class="line"><span class="kd">var</span> <span class="nx">cheerio</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;cheerio&quot;</span><span class="p">);</span></span>
<span id="LC7" class="line"></span>
<span id="LC8" class="line"><span class="c1">// This function will scrape the NYTimes website (cb is our callback)</span></span>
<span id="LC9" class="line"><span class="kd">var</span> <span class="nx">scrape</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">cb</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC10" class="line">  <span class="c1">// Use the request package to take in the body of the page&#39;s html</span></span>
<span id="LC11" class="line">  <span class="nx">request</span><span class="p">(</span><span class="s2">&quot;http://www.nytimes.com&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">,</span> <span class="nx">body</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC12" class="line">    <span class="c1">// body is the actual HTML on the page. Load this into cheerio</span></span>
<span id="LC13" class="line"></span>
<span id="LC14" class="line">    <span class="c1">// Saving this to $ creates a virtual HTML page we can minipulate and</span></span>
<span id="LC15" class="line">    <span class="c1">// traverse with the same methods we&#39;d use in jQuery</span></span>
<span id="LC16" class="line">    <span class="kd">var</span> <span class="nx">$</span> <span class="o">=</span> <span class="nx">cheerio</span><span class="p">.</span><span class="nx">load</span><span class="p">(</span><span class="nx">body</span><span class="p">);</span></span>
<span id="LC17" class="line"></span>
<span id="LC18" class="line">    <span class="c1">// Make an empty array to save our article info</span></span>
<span id="LC19" class="line">    <span class="kd">var</span> <span class="nx">articles</span> <span class="o">=</span> <span class="p">[];</span></span>
<span id="LC20" class="line"></span>
<span id="LC21" class="line">    <span class="c1">// Now, find and loop through each element that has the &quot;theme-summary&quot; class</span></span>
<span id="LC22" class="line">    <span class="c1">// (i.e, the section holding the articles)</span></span>
<span id="LC23" class="line">    <span class="nx">$</span><span class="p">(</span><span class="s2">&quot;.theme-summary&quot;</span><span class="p">).</span><span class="nx">each</span><span class="p">(</span><span class="kd">function</span><span class="p">(</span><span class="nx">i</span><span class="p">,</span> <span class="nx">element</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC24" class="line">      <span class="c1">// In each .theme-summary, we grab the child with the class story-heading</span></span>
<span id="LC25" class="line"></span>
<span id="LC26" class="line">      <span class="c1">// Then we grab the inner text of the this element and store it</span></span>
<span id="LC27" class="line">      <span class="c1">// to the head variable. This is the article headline</span></span>
<span id="LC28" class="line">      <span class="kd">var</span> <span class="nx">head</span> <span class="o">=</span> <span class="nx">$</span><span class="p">(</span><span class="k">this</span><span class="p">).</span><span class="nx">children</span><span class="p">(</span><span class="s2">&quot;.story-heading&quot;</span><span class="p">).</span><span class="nx">text</span><span class="p">().</span><span class="nx">trim</span><span class="p">();</span></span>
<span id="LC29" class="line"></span>
<span id="LC30" class="line">      <span class="c1">// Grab the URL of the article</span></span>
<span id="LC31" class="line">      <span class="kd">var</span> <span class="nx">url</span> <span class="o">=</span> <span class="nx">$</span><span class="p">(</span><span class="k">this</span><span class="p">).</span><span class="nx">children</span><span class="p">(</span><span class="s2">&quot;.story-heading&quot;</span><span class="p">).</span><span class="nx">children</span><span class="p">(</span><span class="s2">&quot;a&quot;</span><span class="p">).</span><span class="nx">attr</span><span class="p">(</span><span class="s2">&quot;href&quot;</span><span class="p">);</span></span>
<span id="LC32" class="line"></span>
<span id="LC33" class="line">      <span class="c1">// Then we grab any children with the class of summary and then grab it&#39;s inner text</span></span>
<span id="LC34" class="line">      <span class="c1">// We store this to the sum variable. This is the article summary</span></span>
<span id="LC35" class="line">      <span class="kd">var</span> <span class="nx">sum</span> <span class="o">=</span> <span class="nx">$</span><span class="p">(</span><span class="k">this</span><span class="p">).</span><span class="nx">children</span><span class="p">(</span><span class="s2">&quot;.summary&quot;</span><span class="p">).</span><span class="nx">text</span><span class="p">().</span><span class="nx">trim</span><span class="p">();</span></span>
<span id="LC36" class="line"></span>
<span id="LC37" class="line">      <span class="c1">// So long as our headline and sum and url aren&#39;t empty or undefined, do the following</span></span>
<span id="LC38" class="line">      <span class="k">if</span> <span class="p">(</span><span class="nx">head</span> <span class="o">&amp;&amp;</span> <span class="nx">sum</span> <span class="o">&amp;&amp;</span> <span class="nx">url</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC39" class="line">        <span class="c1">// This section uses regular expressions and the trim function to tidy our headlines and summaries</span></span>
<span id="LC40" class="line">        <span class="c1">// We&#39;re removing extra lines, extra spacing, extra tabs, etc.. to increase to typographical cleanliness.</span></span>
<span id="LC41" class="line">        <span class="kd">var</span> <span class="nx">headNeat</span> <span class="o">=</span> <span class="nx">head</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/</span><span class="se">(\r\n</span><span class="sr">|</span><span class="se">\n</span><span class="sr">|</span><span class="se">\r</span><span class="sr">|</span><span class="se">\t</span><span class="sr">|</span><span class="se">\s</span><span class="sr">+</span><span class="se">)</span><span class="sr">/gm</span><span class="p">,</span> <span class="s2">&quot; &quot;</span><span class="p">).</span><span class="nx">trim</span><span class="p">();</span></span>
<span id="LC42" class="line">        <span class="kd">var</span> <span class="nx">sumNeat</span> <span class="o">=</span> <span class="nx">sum</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/</span><span class="se">(\r\n</span><span class="sr">|</span><span class="se">\n</span><span class="sr">|</span><span class="se">\r</span><span class="sr">|</span><span class="se">\t</span><span class="sr">|</span><span class="se">\s</span><span class="sr">+</span><span class="se">)</span><span class="sr">/gm</span><span class="p">,</span> <span class="s2">&quot; &quot;</span><span class="p">).</span><span class="nx">trim</span><span class="p">();</span></span>
<span id="LC43" class="line"></span>
<span id="LC44" class="line">        <span class="c1">// Initialize an object we will push to the articles array</span></span>
<span id="LC45" class="line"></span>
<span id="LC46" class="line">        <span class="kd">var</span> <span class="nx">dataToAdd</span> <span class="o">=</span> <span class="p">{</span></span>
<span id="LC47" class="line">          <span class="na">headline</span><span class="p">:</span> <span class="nx">headNeat</span><span class="p">,</span></span>
<span id="LC48" class="line">          <span class="na">summary</span><span class="p">:</span> <span class="nx">sumNeat</span><span class="p">,</span></span>
<span id="LC49" class="line">          <span class="na">url</span><span class="p">:</span> <span class="nx">url</span></span>
<span id="LC50" class="line">        <span class="p">};</span></span>
<span id="LC51" class="line"></span>
<span id="LC52" class="line">        <span class="nx">articles</span><span class="p">.</span><span class="nx">push</span><span class="p">(</span><span class="nx">dataToAdd</span><span class="p">);</span></span>
<span id="LC53" class="line">      <span class="p">}</span></span>
<span id="LC54" class="line">    <span class="p">});</span></span>
<span id="LC55" class="line">    <span class="c1">// After our loop is complete, send back the array of articles to the callback function</span></span>
<span id="LC56" class="line">    <span class="nx">cb</span><span class="p">(</span><span class="nx">articles</span><span class="p">);</span></span>
<span id="LC57" class="line">  <span class="p">});</span></span>
<span id="LC58" class="line"><span class="p">};</span></span>
<span id="LC59" class="line"></span>
<span id="LC60" class="line"><span class="c1">// Export the function, so other files in our backend can use it</span></span>
<span id="LC61" class="line"><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="nx">scrape</span><span class="p">;</span></span></code></pre>
