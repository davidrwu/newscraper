...
<meta content='18-Week/Homework/Solutions/config/routes.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='og:title'>
...
<meta content='https://uclax.bootcampcontent.com/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/config/routes.js' property='og:url'>
<meta content='summary' property='twitter:card'>
<meta content='18-Week/Homework/Solutions/config/routes.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository' property='twitter:title'>
...
<title>18-Week/Homework/Solutions/config/routes.js · master · UCLA-Coding-Boot-Camp / 04-2017-Class-Repository · GitLab</title>
...
<meta name="csrf-token" content="Uwh70g49LpE2hF+rQUF59YKtUjY3pYmUCFhIg6GbcrIpKUTzwwlxNU5v4iWArDki8QhVbIn+y3gRD5F3v8JTPg==" />
<script>
//<![CDATA[
...
<input type="hidden" name="path" id="path" value="18-Week/Homework/Solutions/config/routes.js" />
</form>
...
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/tree/master/18-Week/Homework/Solutions/config">config</a>
</li>
<li>
<a href="/UCLA-Coding-Boot-Camp/04-2017-Class-Repository/blob/master/18-Week/Homework/Solutions/config/routes.js"><strong>
routes.js
</strong>
</a></li>
</ul>
...
<div class='blob-content' data-blob-id='5727010989c6996dd4a6debe51df54fdcb6396b4'>
<pre class="code highlight"><code><span id="LC1" class="line"><span class="c1">// Server routes</span></span>
<span id="LC2" class="line"><span class="c1">// =============</span></span>
<span id="LC3" class="line"></span>
<span id="LC4" class="line"><span class="c1">// Bring headlines and notes from the controller</span></span>
<span id="LC5" class="line"><span class="kd">var</span> <span class="nx">headlinesController</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;../controllers/headlines&quot;</span><span class="p">);</span></span>
<span id="LC6" class="line"><span class="kd">var</span> <span class="nx">notesController</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;../controllers/notes&quot;</span><span class="p">);</span></span>
<span id="LC7" class="line"></span>
<span id="LC8" class="line"><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">router</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC9" class="line">  <span class="c1">// This route renders the homepage</span></span>
<span id="LC10" class="line">  <span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s2">&quot;/&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC11" class="line">    <span class="nx">res</span><span class="p">.</span><span class="nx">render</span><span class="p">(</span><span class="s2">&quot;home&quot;</span><span class="p">);</span></span>
<span id="LC12" class="line">  <span class="p">});</span></span>
<span id="LC13" class="line"></span>
<span id="LC14" class="line">  <span class="c1">// This route renders the saved handledbars page</span></span>
<span id="LC15" class="line">  <span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s2">&quot;/saved&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC16" class="line">    <span class="nx">res</span><span class="p">.</span><span class="nx">render</span><span class="p">(</span><span class="s2">&quot;saved&quot;</span><span class="p">);</span></span>
<span id="LC17" class="line">  <span class="p">});</span></span>
<span id="LC18" class="line"></span>
<span id="LC19" class="line">  <span class="c1">// This route handles scraping more articles to add to our db</span></span>
<span id="LC20" class="line">  <span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s2">&quot;/api/fetch&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC21" class="line">    <span class="c1">// This method inside the headlinesController will try and scrap new articles</span></span>
<span id="LC22" class="line">    <span class="c1">// and save unique ones to our database</span></span>
<span id="LC23" class="line">    <span class="nx">headlinesController</span><span class="p">.</span><span class="nx">fetch</span><span class="p">(</span><span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">docs</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC24" class="line">      <span class="c1">// If we don&#39;t get any articles back, likely because there are no new</span></span>
<span id="LC25" class="line">      <span class="c1">// unique articles, send this message back to the user</span></span>
<span id="LC26" class="line">      <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="nx">docs</span> <span class="o">||</span> <span class="nx">docs</span><span class="p">.</span><span class="nx">insertedCount</span> <span class="o">===</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC27" class="line">        <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">({</span></span>
<span id="LC28" class="line">          <span class="na">message</span><span class="p">:</span> <span class="s2">&quot;No new articles today. Check back tomorrow!&quot;</span></span>
<span id="LC29" class="line">        <span class="p">});</span></span>
<span id="LC30" class="line">      <span class="p">}</span></span>
<span id="LC31" class="line">      <span class="k">else</span> <span class="p">{</span></span>
<span id="LC32" class="line">        <span class="c1">// Otherwise send back a count of how many new articles we got</span></span>
<span id="LC33" class="line">        <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">({</span></span>
<span id="LC34" class="line">          <span class="na">message</span><span class="p">:</span> <span class="s2">&quot;Added &quot;</span> <span class="o">+</span> <span class="nx">docs</span><span class="p">.</span><span class="nx">insertedCount</span> <span class="o">+</span> <span class="s2">&quot; new articles!&quot;</span></span>
...
<span id="LC40" class="line">  <span class="c1">// This route handles getting all headlines from our database</span></span>
<span id="LC41" class="line">  <span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s2">&quot;/api/headlines&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC42" class="line">    <span class="c1">// Run the headlinesController get method and pass in whether we want saved, unsaved,</span></span>
<span id="LC43" class="line">    <span class="c1">// (or all headlines by default)</span></span>
<span id="LC44" class="line">    <span class="nx">headlinesController</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="nx">req</span><span class="p">.</span><span class="nx">query</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC45" class="line">      <span class="c1">// Send the article data back as JSON</span></span>
<span id="LC46" class="line">      <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span></span>
<span id="LC47" class="line">    <span class="p">});</span></span>
<span id="LC48" class="line">  <span class="p">});</span></span>
<span id="LC49" class="line"></span>
<span id="LC50" class="line">  <span class="c1">// This route handles deleting a specified headline</span></span>
<span id="LC51" class="line">  <span class="nx">router</span><span class="p">.</span><span class="k">delete</span><span class="p">(</span><span class="s2">&quot;/api/headlines/:id&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC52" class="line">    <span class="c1">// Set the _id property of the query object to the id in req.params</span></span>
<span id="LC53" class="line">    <span class="kd">var</span> <span class="nx">query</span> <span class="o">=</span> <span class="p">{</span> <span class="na">_id</span><span class="p">:</span> <span class="nx">req</span><span class="p">.</span><span class="nx">params</span><span class="p">.</span><span class="nx">id</span> <span class="p">};</span></span>
<span id="LC54" class="line"></span>
<span id="LC55" class="line">    <span class="c1">// Run the headlinesController delete method and pass in our query object containing</span></span>
<span id="LC56" class="line">    <span class="c1">// the id of the headline we want to delete</span></span>
<span id="LC57" class="line">    <span class="nx">headlinesController</span><span class="p">.</span><span class="k">delete</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC58" class="line">      <span class="c1">// Send the result back as JSON to be handled client side</span></span>
<span id="LC59" class="line">      <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span></span>
<span id="LC60" class="line">    <span class="p">});</span></span>
<span id="LC61" class="line">  <span class="p">});</span></span>
<span id="LC62" class="line"></span>
<span id="LC63" class="line">  <span class="c1">// This route handles updating a headline, in particular saving one</span></span>
<span id="LC64" class="line">  <span class="nx">router</span><span class="p">.</span><span class="nx">put</span><span class="p">(</span><span class="s2">&quot;/api/headlines&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC65" class="line">    <span class="c1">// Construct a query object to send to the headlinesController with the</span></span>
<span id="LC66" class="line">    <span class="c1">// id of the headline to be saved</span></span>
<span id="LC67" class="line"></span>
<span id="LC68" class="line">    <span class="c1">// We&#39;re using req.body here instead of req.params to make this route easier to</span></span>
<span id="LC69" class="line">    <span class="c1">// change if we ever want to update a headline in any way except saving it</span></span>
<span id="LC70" class="line"></span>
<span id="LC71" class="line">    <span class="nx">headlinesController</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="nx">req</span><span class="p">.</span><span class="nx">body</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC72" class="line">      <span class="c1">// After completion, send the result back to the user</span></span>
<span id="LC73" class="line">      <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span></span>
<span id="LC74" class="line">    <span class="p">});</span></span>
<span id="LC75" class="line">  <span class="p">});</span></span>
<span id="LC76" class="line"></span>
<span id="LC77" class="line">  <span class="c1">// This route handles getting notes for a particular headline id</span></span>
<span id="LC78" class="line">  <span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s2">&quot;/api/notes/&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC79" class="line">    <span class="c1">// Get all notes</span></span>
<span id="LC80" class="line">    <span class="nx">notesController</span><span class="p">.</span><span class="nx">get</span><span class="p">({},</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC81" class="line">      <span class="c1">// Send the note data back to the user as JSON</span></span>
<span id="LC82" class="line">      <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span></span>
<span id="LC83" class="line">    <span class="p">});</span></span>
<span id="LC84" class="line">  <span class="p">});</span></span>
<span id="LC85" class="line"></span>
<span id="LC86" class="line">  <span class="c1">// This route handles getting notes for a particular headline id</span></span>
<span id="LC87" class="line">  <span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s2">&quot;/api/notes/:headline_id&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC88" class="line">    <span class="kd">var</span> <span class="nx">query</span> <span class="o">=</span> <span class="p">{</span> <span class="na">_id</span><span class="p">:</span> <span class="nx">req</span><span class="p">.</span><span class="nx">params</span><span class="p">.</span><span class="nx">headline_id</span> <span class="p">};</span></span>
<span id="LC89" class="line"></span>
<span id="LC90" class="line">    <span class="c1">// Get all notes that match our query using the notesController get method</span></span>
<span id="LC91" class="line">    <span class="nx">notesController</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC92" class="line">      <span class="c1">// Send the note data back to the user as JSON</span></span>
<span id="LC93" class="line">      <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span></span>
<span id="LC94" class="line">    <span class="p">});</span></span>
<span id="LC95" class="line">  <span class="p">});</span></span>
<span id="LC96" class="line"></span>
<span id="LC97" class="line">  <span class="c1">// This route handles deleting a note of a particular note id</span></span>
<span id="LC98" class="line">  <span class="nx">router</span><span class="p">.</span><span class="k">delete</span><span class="p">(</span><span class="s2">&quot;/api/notes/:id&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC99" class="line">    <span class="kd">var</span> <span class="nx">query</span> <span class="o">=</span> <span class="p">{</span> <span class="na">_id</span><span class="p">:</span> <span class="nx">req</span><span class="p">.</span><span class="nx">params</span><span class="p">.</span><span class="nx">id</span> <span class="p">};</span></span>
<span id="LC100" class="line"></span>
<span id="LC101" class="line">    <span class="c1">// Use the check function from the headlines controller,</span></span>
<span id="LC102" class="line">    <span class="c1">// this checks all of our articles, sorted by id number</span></span>
<span id="LC103" class="line">    <span class="nx">notesController</span><span class="p">.</span><span class="k">delete</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC104" class="line">      <span class="c1">// Send the article data to a json</span></span>
<span id="LC105" class="line">      <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span></span>
...
<span id="LC109" class="line">  <span class="c1">// This route handles saving a new note</span></span>
<span id="LC110" class="line">  <span class="nx">router</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="s2">&quot;/api/notes&quot;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC111" class="line">    <span class="nx">notesController</span><span class="p">.</span><span class="nx">save</span><span class="p">(</span><span class="nx">req</span><span class="p">.</span><span class="nx">body</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="p">{</span></span>
<span id="LC112" class="line">      <span class="c1">// Send the note to the browser as a json</span></span>
<span id="LC113" class="line">      <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span></span>
<span id="LC114" class="line">    <span class="p">});</span></span>
<span id="LC115" class="line">  <span class="p">});</span></span>
<span id="LC116" class="line"><span class="p">};</span></span></code></pre>
